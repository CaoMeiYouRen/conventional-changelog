...
* `formatDate` option ([#1189](https://github.com/CaoMeiYouRen/conventional-changelog/issues/1189)) ([8c4bbbe](https://github.com/CaoMeiYouRen/conventional-changelog/commit/8c4bbbe2945a23bd3660a2dbfe1b497fda03afa4)), closes [#1186](https://github.com/CaoMeiYouRen/conventional-changelog/issues/1186)
* `transformCommit` method and utils are added to exports ([#1350](https://github.com/CaoMeiYouRen/conventional-changelog/issues/1350)) ([6a05bad](https://github.com/CaoMeiYouRen/conventional-changelog/commit/6a05bad6c54381e5ba403449f0009e23aa7e7b31))
* add helper for parsing array of commits ([#711](https://github.com/CaoMeiYouRen/conventional-changelog/issues/711)) ([e869fe6](https://github.com/CaoMeiYouRen/conventional-changelog/commit/e869fe67548b210508a9df0ce99180164b740e65))
* add skip option for skipping commits when writing changelog ([#1346](https://github.com/CaoMeiYouRen/conventional-changelog/issues/1346)) ([b3e3042](https://github.com/CaoMeiYouRen/conventional-changelog/commit/b3e3042a2a9fc9877f279e36dead38af51c233a2)), closes [#1179](https://github.com/CaoMeiYouRen/conventional-changelog/issues/1179) [#342](https://github.com/CaoMeiYouRen/conventional-changelog/issues/342)
* align methods with other packages ([#1182](https://github.com/CaoMeiYouRen/conventional-changelog/issues/1182)) ([7b13ec9](https://github.com/CaoMeiYouRen/conventional-changelog/commit/7b13ec9afcbe7afc24ce47af805c339ba7f0276f))
...
* rewrite to TypeScript ([#1150](https://github.com/CaoMeiYouRen/conventional-changelog/issues/1150)) ([8af364f](https://github.com/CaoMeiYouRen/conventional-changelog/commit/8af364feb20f4e6f7ffab6f5b25638df780db715))
* timeZone option ([#1162](https://github.com/CaoMeiYouRen/conventional-changelog/issues/1162)) ([27f3642](https://github.com/CaoMeiYouRen/conventional-changelog/commit/27f36422fdeb9a855c26ceac6d80896af0918764))
...
* use Intl.DateTimeFormat instead of dateformat ([#1075](https://github.com/CaoMeiYouRen/conventional-changelog/issues/1075)) ([77c41e9](https://github.com/CaoMeiYouRen/conventional-changelog/commit/77c41e93fe66c2287aad2c266dda91ebf978882a))
* use new api of `references` and `notes` ([4d27326](https://github.com/CaoMeiYouRen/conventional-changelog/commit/4d27326299d1f7307d98d9021bf8b30540823715))
...
* address CVE in meow ([#642](https://github.com/CaoMeiYouRen/conventional-changelog/issues/642)) ([46311d2](https://github.com/CaoMeiYouRen/conventional-changelog/commit/46311d2932b367f370d06c4e447b8dcf4bc4e83f))
* align split2 package between packages ([#1084](https://github.com/CaoMeiYouRen/conventional-changelog/issues/1084)) ([bf28e5f](https://github.com/CaoMeiYouRen/conventional-changelog/commit/bf28e5f9e1678833356e6b58ddebfb7d6ceb6f1d))
* bad release of conventional-changelog-writer ([b5da9af](https://github.com/CaoMeiYouRen/conventional-changelog/commit/b5da9afe056ad4597c2503e28060cc6c2f28b19a))
* concat-stream should be in devdeps ([e90881c](https://github.com/CaoMeiYouRen/conventional-changelog/commit/e90881ce673eb892ca21102a1bb8c5489770abfb))
* drop compare-func making sort consistent across node versions ([#729](https://github.com/CaoMeiYouRen/conventional-changelog/issues/729)) ([e0081a8](https://github.com/CaoMeiYouRen/conventional-changelog/commit/e0081a829133891e2def4a7b7ee5fa25f1440049))
* fix modification prevention for Date objects ([#1285](https://github.com/CaoMeiYouRen/conventional-changelog/issues/1285)) ([56a5f3c](https://github.com/CaoMeiYouRen/conventional-changelog/commit/56a5f3cbbab72d8bb1f19aa697927a8f24490812))
...
* fix transform async handlers ([#1146](https://github.com/CaoMeiYouRen/conventional-changelog/issues/1146)) ([be3901b](https://github.com/CaoMeiYouRen/conventional-changelog/commit/be3901bc66e44f938c4a9634b697a0c79841635a))
* linting ([33ac525](https://github.com/CaoMeiYouRen/conventional-changelog/commit/33ac525e294aca4a3b736a67d5b0ae17129027a1))
...
* pass commit deep copy to writer transformer ([#1044](https://github.com/CaoMeiYouRen/conventional-changelog/issues/1044)) ([208ffdb](https://github.com/CaoMeiYouRen/conventional-changelog/commit/208ffdb246b6acf4f016c6ca6e02b2e347c6bd67)), closes [#1043](https://github.com/CaoMeiYouRen/conventional-changelog/issues/1043)
* patch the handlebars package for CVE-2021-23369 ([1cfc3a1](https://github.com/CaoMeiYouRen/conventional-changelog/commit/1cfc3a1600a11a61d1a9e8d3051d1101cfaa36f1))
* require split2 ([59db605](https://github.com/CaoMeiYouRen/conventional-changelog/commit/59db605a988a852b5fb7e2fa591f75b67a16e006))
* revert previous change ([2f4530f](https://github.com/CaoMeiYouRen/conventional-changelog/commit/2f4530f06cb8f76e83c5f9c7af8126952b4dc8f3))
...
* update dependency semver to v6 ([#458](https://github.com/CaoMeiYouRen/conventional-changelog/issues/458)) ([efaa7bb](https://github.com/CaoMeiYouRen/conventional-changelog/commit/efaa7bb651fe1b6de047163fc9db8e5d69f0a6e9))
* update dependency semver to v7 [security] ([#1021](https://github.com/CaoMeiYouRen/conventional-changelog/issues/1021)) ([31fa409](https://github.com/CaoMeiYouRen/conventional-changelog/commit/31fa409e446a51a5a23e2217997d04364b89c1dd))
...
* chore(deps): switch to split2 ([4be1188](https://github.com/CaoMeiYouRen/conventional-changelog/commit/4be1188767e493fef95f8222fcfd8aefec6914e8))
* fix(deps): require split2 ([c93a12a](https://github.com/CaoMeiYouRen/conventional-changelog/commit/c93a12a589e7c1527ac5af106e4fa04a5610caca))
...
* remove anchor from header templates ([#301](https://github.com/CaoMeiYouRen/conventional-changelog/issues/301)) ([346f24f](https://github.com/CaoMeiYouRen/conventional-changelog/commit/346f24f0f8d92b64ed62658796d1876a52ec3ab3)), closes [#186](https://github.com/CaoMeiYouRen/conventional-changelog/issues/186)
